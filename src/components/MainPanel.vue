<template>
    <div class="_1-iDe Wu52Z">
        <div v-if="!activeChat" class="_2zynu">
            <div class="_2IVU3">
                ...
                <div class="_3MiDj" style="opacity: 1; transform: translateY(0px);"><h1 class="P8cO8">Keep your phone
                    connected</h1>
                    <div class="dPZky">{{activeChat}} WhaghgfhtsApp connects to your phone to sync messages. To
                        reduce data usage,
                        connect
                        your phone to Wi-Fi.
                    </div>
                    <div class="_3McX8">
                        <div class="_1TgXb"></div>
                        <div class="_2g-bt">
                        </div>
                    </div>
                </div>
        ...
        <div v-else id="main" class="_1GX8_">
            ...
            <header class="_2y17h">
                ...
                <div class="_5SiUq" role="button">
                    ...
                    <div class="_3sgkv Gd51Q"><span title="terakhir dilihat kemarin pukul 07.45"
                                                    class="O90ur _3FXB1">terakhir dilihat kemarin pukul 07.45</span>
                    </div>
                </div>
                <div class="YmSrp">
                    <div class="_3Kxus ba6sz">
                        <div class="rAUz7">
                            <div role="button" title="Cari..."><span data-icon="search-alt" class=""><svg
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
                                    height="24"><path fill="currentColor"
                            ...
                            <span></span></div>
                        <div class="rAUz7">
                            <div role="button" title="Lampirkan">
                                <span data-icon="clip" class=""><svg
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
                                        height="24"><path fill="currentColor"
                        ...
                        <div class="rAUz7">
                            <div role="button" title="Menu"><span data-icon="menu" class=""><svg
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
                                    height="24"><path fill="currentColor"
                                                      d="M12 7a2 2 0 1 0-.001-4.001A2 2 0 0 0 12 7zm0 2a2 2 0 1 0-.001 3.999A2 2 0 0 0 12 9zm0 6a2 2 0 1 0-.001 3.999A2 2 0 0 0 12 15z"></path></svg></span>
                            </div>
                            <span></span></div>
                    </div>
                </div>
